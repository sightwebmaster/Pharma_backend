...
public class PatientProfileMapperImpl implements PatientProfileMapper {
    ...
    public PatientProfile toDomain(CreatePatientProfileRequest request) {
        ...
        patientProfile.enceinte( request.getEnceinte() );
    ...
    public PatientProfileResponse toResponse(PatientProfile domain) {
        ...
        patientProfileResponse.setEnceinte( domain.getEnceinte() );
        ...
        patientProfileResponse.setEmail( domain.getEmail() );
        patientProfileResponse.setPhotoBase64( domain.getPhotoBase64() );
    ...
    public void updateDomainFromRequest(UpdatePatientProfileRequest request, PatientProfile domain) {
        ...
        if ( request.getEnceinte() != null ) {
            domain.setEnceinte( request.getEnceinte() );
        }
        ...
        if ( request.getPhotoBase64() != null ) {
            domain.setPhotoBase64( request.getPhotoBase64() );
        }
    }
}
